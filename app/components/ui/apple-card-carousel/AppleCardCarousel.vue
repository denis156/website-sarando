...
<template>
  <div class="relative w-full">
    <div
      ref="carouselRef"
      class="flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth pb-10 pt-4 [scrollbar-width:none] md:pb-20 md:pt-8"
      @scroll="checkScrollability"
    >
      <div
        class="absolute right-0 z-1000 h-auto w-[5%] overflow-hidden bg-linear-to-l"
      />
