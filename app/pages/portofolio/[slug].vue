...
<template>
  <main class="min-h-screen bg-background pb-20 overflow-x-hidden">
    ...
    <template v-else>
      <div
        class="container max-w-7xl mx-auto px-6 pt-24 lg:pt-32 pb-12 lg:pb-20"
      >
        <!-- Back Link -->
        <NuxtLink
          to="/portofolio"
        ...
        <div
          ...
          class="relative w-full aspect-video rounded-3xl overflow-hidden shadow-2xl border border-border/50 group mb-8 lg:mb-12"
        >
          <div
        ...
        <!-- HERO TEXT (Moved Below Image) -->
        <div class="space-y-6 max-w-4xl mb-12 lg:mb-20">
          ...
          <BoxReveal :duration="0.6">
            <h1
              class="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-[1.1]"
            >
              {{ project.title }}
            </h1>
          </BoxReveal>
          ...
          <BoxReveal :duration="0.7">
            <p
              class="text-lg md:text-2xl text-muted-foreground leading-relaxed max-w-2xl"
            >
              {{ project.description }}
            </p>
          </BoxReveal>
              ...
              <AppleCardCarousel>
                ...
                >
                  <div class="flex flex-col items-center justify-center">
                    ...
                    />
                    <h4 class="text-lg font-bold text-center mt-4">
                      {{ card.title }}
                    </h4>
                  </div>
                </AppleCard>
